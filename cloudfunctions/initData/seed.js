// initData 种子数据 —— 学科、知识点、示例题目（含分步解析）
// 覆盖四种题型，展示「分步解析 steps」的写法规范
module.exports = {
  subjects: [
    { name: '数学', icon: '📐', color: '#4A6CF7', order: 1 },
    { name: '物理', icon: '⚛️', color: '#2FB26A', order: 2 }
  ],

  knowledgePoints: [
    { subject: '数学', name: '二次函数', order: 1 },
    { subject: '数学', name: '一元二次方程', order: 2 },
    { subject: '数学', name: '等差数列', order: 3 },
    { subject: '物理', name: '牛顿运动定律', order: 1 },
    { subject: '物理', name: '匀变速直线运动', order: 2 }
  ],

  questions: [
    {
      subject: '数学', point: '二次函数', difficulty: 1, type: 'single',
    ...
    {
      subject: '数学', point: '一元二次方程', difficulty: 2, type: 'multiple',
    ...
    {
      subject: '数学', point: '等差数列', difficulty: 1, type: 'fill',
    ...
    {
      subject: '数学', point: '二次函数', difficulty: 3, type: 'solution',
    ...
    {
      subject: '物理', point: '牛顿运动定律', difficulty: 1, type: 'single',
    ...
    {
      subject: '物理', point: '匀变速直线运动', difficulty: 2, type: 'fill',
    ...
    {
      subject: '物理', point: '牛顿运动定律', difficulty: 3, type: 'solution',
